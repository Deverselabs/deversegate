...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn('p-4 sm:p-3', className)}
      classNames={{
        ...
        nav_button: cn(
          ...
          'h-10 w-10 sm:h-7 sm:w-7 bg-transparent p-0 opacity-50 hover:opacity-100 touch-manipulation'
        ),
        ...
        day: cn(
          ...
          'h-11 sm:h-9 w-11 sm:w-9 p-0 font-normal aria-selected:opacity-100 touch-manipulation'
        ),
